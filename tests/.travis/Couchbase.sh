...
untilsuccessful docker exec -it $ID /opt/couchbase/bin/couchbase-cli bucket-create -c localhost:8091 -u Administrator -p password --bucket=default --bucket-password= --bucket-type=couchbase --bucket-port=11211 --bucket-ramsize=1500 --bucket-replica=0 --enable-flush=1 --wait
